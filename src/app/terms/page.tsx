    ...
    <div className="flex">
      <ArticleContent>
        ...
        <p>
          ...
          <Link href={'https://www.usesonibble.site'}>
            https://www.usesonibble.site
          </Link>{' '}
        ...
        <p>
          ...
          graphics, logos, images, and software, is the property of Sonibble and
